...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        ...
        % Edges (FIFOs)
        \draw[arrow] (a0) -- node[above left, font=\tiny, color=black] {/tmp/fifo_0_1} (a1);
        \draw[arrow] (a0) -- node[above right, font=\tiny, color=black] {/tmp/fifo_0_2} (a2);
        \draw[arrow] (a1) -- node[below left, font=\tiny, color=black] {/tmp/fifo_1_3} (a3);
        \draw[arrow] (a2) -- node[below right, font=\tiny, color=black] {/tmp/fifo_2_3} (a3);
