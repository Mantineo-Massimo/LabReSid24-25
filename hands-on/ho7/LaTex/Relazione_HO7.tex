...
\title{\vspace{-2cm}Relazione: Software Defined Networking e Mininet\\
\large (Hands-On 7)}
...
Tramite l'API Python di Mininet, è stato implementato un \texttt{GenericRouter}. Il nodo router abilita l'instradamento globale tramite il flag del kernel \texttt{ip_forward}:
...
$ sudo python3 ex2_router.py
$ sudo python3 ex3_tc.py
\end{terminal}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{ho7/ho7_wireshark_ex2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{ho7/ho7_wireshark_ex3.png}
...
I test con \texttt{iperf} hanno mostrato un throughput stabile a 75 Mbps (sotto il limite di 100 Mbps a causa dell'overhead del protocollo e del ritardo elevato che influenza la finestra di congestione TCP), validando la fedeltà del modello TCLink.
