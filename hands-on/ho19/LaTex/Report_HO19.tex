...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        ...
        % Workers
        \node[worker, below left=2cm and 1cm of agg] (w1) {Worker 1\\(Local Data $D_1$)};
        \node[worker, below=2.5cm of agg] (w2) {Worker 2\\(Local Data $D_2$)};
        \node[worker, below right=2cm and 1cm of agg] (w3) {Worker 3\\(Local Data $D_3$)};
