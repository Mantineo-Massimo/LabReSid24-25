...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        node distance=2.5cm,
        router/.style={circle, draw=blue!70, fill=blue!5, thick, minimum size=1.2cm, font=\small\bfseries},
    ...
    \label{fig:bellman\_ford\_graph}
\end{figure}
...
massimo@PORTATILE-Linux:~/Scrivania/LabReSid24-25/hands-on/ho17$ ./bellman\_ford 
