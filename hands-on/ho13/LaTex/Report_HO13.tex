...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        ...
        \node[font=\tiny] at (0,-1) [left=0.1cm] {Work};
        
        \draw[ultra thick, orange!70] (0,-1.5) -- (0,-4.5);
        \node[font=\tiny, color=orange!80!black] at (0,-3) [left=0.1cm] {WAITING (Sleeping)};
        
        \draw[ultra thick, blue!70] (0,-4.5) -- (0,-5.5);
        \node[font=\tiny] at (0,-5) [left=0.1cm] {Resume Work};

        % Child states
        \draw[ultra thick, green!70!black] (5,-1.5) -- (5,-4.5);
        \node[font=\tiny] at (5,-3) [right=0.1cm] {Performing Task};
...
// Se e' qui in basso, cond_signal e' arrivato e lock e' stato ripreso in mano!
