...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        ...
        % Signals
        \draw[arrow, red, dashed] (0,-1.5) -- node[above, font=\tiny, color=black] {pthread_cond_wait()} (5,-1.5);
        \draw[arrow, red, very thick] (5,-4.5) -- node[above, font=\tiny, color=black] {pthread_cond_signal()} (0,-4.5);

        \node[msg] at (2.5, -5.5) {child_done = 1};
    \end{tikzpicture}
