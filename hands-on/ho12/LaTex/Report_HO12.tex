...
\usepackage{tikz}
\usetikzlibrary{positioning, arrows.meta, shapes.symbols, shapes.multipart}
\usepackage{listings}
\usepackage{xcolor}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        ...
        buffer/.style={rectangle split, rectangle split parts=5, draw=orange!70, fill=orange!5, thick, minimum width=2cm, align=center, font=\tiny\ttfamily},
...
\begin{itemize}
    \item \textbf{Gestione Dinamica del Pool}: Implementazione di un sistema di ridimensionamento automatico del numero di thread in base al tasso di riempimento del buffer.
    \item \textbf{Priority Queuing}: Evoluzione del buffer FIFO in una coda a priorità per il trattamento differenziato dei messaggi urgenti.
\end{itemize}
\end{document}