...
\title{\vspace{-2cm}Relazione: Client UDP Multicast\\
\large (Hands-On 6)}
...
\section{Obiettivo dell'Esercitazione}
...
\section{Analisi Tecnica: il Multicast UDP}
...
\section{Implementazione del Client (\texttt{multicast\_client.c})}
...
\section{Esecuzione e Validazione}
